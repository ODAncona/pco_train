...
// Locomotive A
static Locomotive locoA(15 /* Numéro (pour commande trains sur maquette réelle) */, 10 /* Vitesse */);
// Locomotive B
static Locomotive locoB(14 /* Numéro (pour commande trains sur maquette réelle) */, 12 /* Vitesse */);

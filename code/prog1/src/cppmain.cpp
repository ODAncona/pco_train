...
// Locomotive A
static Locomotive locoA(15 /* Numéro (pour commande trains sur maquette réelle) */, 7 /* Vitesse */);
// Locomotive B
static Locomotive locoB(14 /* Numéro (pour commande trains sur maquette réelle) */, 9 /* Vitesse */);
